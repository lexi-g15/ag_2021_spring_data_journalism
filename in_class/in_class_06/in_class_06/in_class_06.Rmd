...
cases_per_thousand <- state_covid_population %>%
  mutate(cases_per_thousand = (total_cases/population)*1000) %>%
...
# Which state had the lowest number of COVID-19 DEATHS per 1,000 people on August 30, 2020?

deaths_per_thousand <- state_covid_population %>%
mutate(deaths_per_thousand = (total_deaths/population)*1000) %>%
arrange (deaths_per_thousand)
