...
covid_virginia_august_rate <- covid_county_august_case_rate %>%
    filter(state == "Virginia")

covid_virginia_august_rate
```
...
# Answer: Liberty County in Florida had the smallest percent change in monthly cornavirus case rates between June and August with 95 percent. 
