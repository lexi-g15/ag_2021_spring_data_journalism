...
# A: Prince George's County had the highest case rate on August 30, with  29 cases per 1,000. 
...
# A: Bath, Virginia had the LOWEST case rate on August 30, with 0.9 cases per 1,000. 
...
# A: Two areas in the U.S., Hancock, Georgia and Galax city, Virgina, had a death rate above 4 per 1,000. 
...
# A: Kent, Maryland had a death rate higher than 1 per 1,000 in August. 
...
# A: Galax city, Emporia city and Northampton. 
...
# A: Butte, Idaho had the biggest percentage jump in cumulative case rate between July and August. 
...
covid_maryland_county_death_rate_jun_aug_pct_change <- covid_county_monthly_death_rate %>% 
...
covid_maryland_county_death_rate_jun_aug_pct_change

# Q: which Maryland county had the largest percentage change in cumulative death rate between June and August? 
# A: Queen Anne's county, Maryland had the largest percent change in cumulative death rate between June and August with a percent change of .53. 
...
```{r}
# Code
covid_texas_county_case_rate_may_aug_pct_change <- covid_county_monthly_case_rate %>% 
...
covid_texas_county_case_rate_may_aug_pct_change

# Q: Which Texas county had the smallest percentage change in cumulative case rate between May and August?
# A: Jones, Texas had the smallest percent change in cumulative case rate between May and August. 
...
```{r}
# Q: Which county in California had the biggest jump in cumulative CASES between May and August? 

# Code 
covid_california_county_case_rate_may_aug_jump <- covid_county_monthly_case_rate %>% 
    select(county, state, d_2020_05_30, d_2020_08_30) %>%
    filter(state == "California") %>%
    mutate(may_aug_jump = d_2020_08_30 - d_2020_05_30) %>%
  arrange(desc(may_aug_jump))

# Object 

covid_california_county_case_rate_may_aug_jump

# A: Imperial county in California had the biggest jump in cumulative cases between May and August. 
