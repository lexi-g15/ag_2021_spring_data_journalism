...
arcos_md_baltimorecity_sorted <-
arcos_md_baltimorecity_trimmed %>%   arrange(desc(total_dosage_unit))
```
...
```{r}
# Answer to question 1:GIANT PHARMACY 166. 10365 shipments. 

arcos_md_baltimorecity_question_one <- arcos_md_baltimorecity_trimmed %>% arrange(desc(total_records))
...
```{r}
# Answer to question 2: OSHINSKY, ALAN E MD and 	JAKOBOVITS, JULIAN MD. Both got 4 pills. 
arcos_md_baltimorecity_question_two <- arcos_md_baltimorecity_trimmed %>% arrange(total_dosage_unit)
```
