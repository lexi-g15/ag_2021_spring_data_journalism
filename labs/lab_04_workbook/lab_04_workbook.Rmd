...
# A: New Jersey with 758.9 deaths. 
...
state_cases_in_average_county <- covid_county %>%
  group_by(state) %>%
  summarise(cases_in_average_county = mean(cases)) %>%
  arrange(desc(cases_in_average_county))

# Object 

state_cases_in_average_county

# Question: Which state had the highest average cases? How many cases? 
# A: Arizona with 13446.3 cases 
