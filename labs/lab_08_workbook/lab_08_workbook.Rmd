...
# The names of the columns are too long and need to be cleaned up. They switch between using NA, *Not included - Did not meet inclusion criteria and "*" to show data is not included. This is not uniform. 
